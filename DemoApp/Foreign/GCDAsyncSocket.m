...
- (NSString *)connectedHost
{
	...
	{
		if (self->socket4FD != SOCKET_NULL)
			return [self connectedHostFromSocket4: self->socket4FD];
		if (self->socket6FD != SOCKET_NULL)
			return [self connectedHostFromSocket6: self->socket6FD];
...
- (NSURL *)connectedUrl
{
	...
	{
		if (self->socketUN != SOCKET_NULL)
			return [self connectedUrlFromSocketUN: self->socketUN];
